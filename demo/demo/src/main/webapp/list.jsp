...
<div>
    ...
    <button id="filterButton" class="btn btn-primary">Hiển thị/Tìm kiếm</button> <!-- Thêm nút này -->
</div>
...
<div id="filterForm" class="card d-none">
    <div class="card-body">
        <form action="?action=filter" method="post">
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="name" class="form-label">Mã Mặt Bằng :</label>
                    <input type="text" class="form-control" id="name" name="maMb" >
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
